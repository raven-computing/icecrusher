...
public class WindowsUpdateExecutor extends AbstractUpdateExecutor implements UpdateExecutor {
	...
	protected WindowsUpdateExecutor(final UpdateInfo updateInfo, final UpdateRoutine updateRoutine){
	...
	public void setupInstructions(){
		final Instruction instruct = super.getUpdateInfo().getInstruction(OperatingSystem.WINDOWS);
		if(instruct != null){
	...
	public void doUpdate(){
		...
		try{
			final ProcessBuilder proc = new ProcessBuilder("cmd.exe", "/C", execution, argSource, argTarget);
