...
public class Layout {
     ...
     */
    public static Timeline getTimelineAnimationFor(Transition transition,
            double metric, Parent in, Parent out){
    ...
    private static Timeline slideUpBothTransition(final double height,
            final Parent in, final Parent out){
    ...
    private static Timeline slideDownBothTransition(final double height,
            final Parent in, final Parent out){
