...
/**
 * Wrapper class holding a response to computations for chart data preparations.<br>
 * Objects of this class' type are returned by 
 * {@link XYChartController#prepareData(Column, Column)}
 * 
 */
